...
//@interface TalkToSureshObject : NSObject
//@end

@interface TalkToSureshObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TalkToSureshObject class]])
		{
			for (NSString *key in [[(TalkToSureshObject*)o modules] allKeys])
			{
