...
// in simulator we redefine to format for TalkToSuresh Developer console
...
{\
	NSString * exceptionName = [@"org.talktosuresh." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.talktosuresh";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UITalkToSureshNativeItemNone = -1, 
	UITalkToSureshNativeItemSpinner = -2,
	UITalkToSureshNativeItemProgressBar = -3,
	
	UITalkToSureshNativeItemSlider = -4,
	UITalkToSureshNativeItemSwitch = -5,
	UITalkToSureshNativeItemMultiButton = -6,
	UITalkToSureshNativeItemSegmented = -7,
	
	UITalkToSureshNativeItemTextView = -8,
	UITalkToSureshNativeItemTextField = -9,
	UITalkToSureshNativeItemSearchBar = -10,
	
	UITalkToSureshNativeItemPicker = -11,
	UITalkToSureshNativeItemDatePicker = -12,
	
	UITalkToSureshNativeItemInfoLight = -13,
	UITalkToSureshNativeItemInfoDark = -14,
	
	UITalkToSureshNativeItemDisclosure = -15,
	
	UITalkToSureshNativeItemContactAdd = -16
};
